...
export function AdminDashboardTile({ title, icon, buttonText, onClick, infoText}) {
  return (
    <div className="flex flex-col items-center p-4 h-[20em] rounded-md bg-emerald-200 shadow-md font-mono hover:bg-emerald-100 hover:text-white">
      ...
      <h2 className="text-base font-mono font-semibold text-emerald-700 mt-2 mb-4">
        {title}
      </h2>
      
      <button className="bg-emerald-400 rounded-md whitespace-nowrap p-2 my-4 w-5/6 shadow-lg hover:bg-white hover:text-emerald-600" onClick={onClick}>
        {buttonText}
      </button>
